...
def sigmoidModel():
    ...
    x = layers.Conv2D(16, (3, 3), (1, 1), activation="sigmoid", padding='same')(x)
    x = layers.BatchNormalization()(x, training=True)
    x = layers.MaxPooling2D((2,2))(x)
    x = layers.Conv2D(32, (3, 3), (1, 1), activation="sigmoid", padding='same')(x)
    x = layers.BatchNormalization()(x, training=True)
    x = layers.MaxPooling2D((2,2))(x)
    x = layers.Conv2D(64, (3, 3), (1, 1), activation="sigmoid", padding='same')(x)
    x = layers.BatchNormalization()(x, training=True)
    x = layers.MaxPooling2D((2,2))(x)
    x = layers.Conv2D(128, (3, 3), (1, 1), activation="sigmoid", padding='same')(x)
    x = layers.BatchNormalization()(x, training=True)
    x = layers.MaxPooling2D((2,2))(x)
    x = layers.Conv2D(256, (3, 3), (1, 1), activation="sigmoid", padding='same')(x) 
    x = layers.BatchNormalization()(x, training=True)
    x = layers.MaxPooling2D((2,2))(x)
    x = layers.Conv2D(512, (2, 2), (1, 1), activation="sigmoid", padding='same')(x)
    x = layers.BatchNormalization()(x, training=True) 
    x = layers.MaxPooling2D((2,2))(x)
    x = layers.Flatten()(x)
...
def CNNModelV2():
    ...
    x = layers.Conv2D(64, (3, 3), (1, 1), activation="relu", padding='same')(x)
    x = layers.MaxPooling2D((2,2))(x)
    x = layers.Conv2D(128, (3, 3), (1, 1), activation="relu", padding='same')(x)
    x = layers.MaxPooling2D((2,2))(x)
    x = layers.Conv2D(256, (3, 3), (1, 1), activation="relu", padding='same')(x) 
    x = layers.MaxPooling2D((2,2))(x)
    x = layers.Conv2D(512, (2, 2), (1, 1), activation="relu", padding='same')(x) 
    x = layers.MaxPooling2D((2,2))(x)
    x = layers.Flatten()(x)
    x = layers.Dense(384, activation="relu")(x)
    x = layers.Dropout(0.2)(x)
