...
VOC_images_dir = './test_data/JPEGImages/'
...
VOC_annotations_dir = './test_data/Annotations/'
...
final_epoch     = 3 #120 usually
steps_per_epoch = 1 #1000 usually
